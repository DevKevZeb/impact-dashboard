...
const menuItems: MenuItem[] = [
  {
    ...
    children: [
      ...
      { title: "Project Dashboard", path: "/app/dashboard" },
      {
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Program States", path: "/app/config/program-states", requiredScopes: [SCOPES.PROGRAM_STATES_READ] },
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Unverified Users", path: "/app/admin/users/unverified", requiredScopes: [SCOPES.USERS_READ] },
