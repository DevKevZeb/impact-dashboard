	...
	return (
		<div className="w-full flex flex-col justify-center items-center">
			<div className="w-5/7 flex justify-center mb-20">
				<h1 className="mb-4 second-head-label font-light">KPA: {kpaName}</h1>
			</div>

			<div className="w-full flex justify-center">
				<div className="w-5/7">
					<h1 className="third-head-label">Degree of Implementation</h1>
                    <h3 className="mt-6">{`The degree of implementation is represented as a percentage, indicating the extent of progress made towards the delivery of KPA: ${kpaName} based on the progress made on its Measures.`}</h3>
				</div>
			</div>
