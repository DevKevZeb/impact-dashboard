...
export default function StrategicOutputSelectedSection({ strategicOutputId, strategicOutputName }: Props) {
	const { data, isLoading, error } = useStrategicOutputSelected(strategicOutputId);

	return (
		<div className="w-full flex flex-col justify-center items-center">
			<div className="w-5/7 flex justify-center mb-20">
				<h1 className="mb-4 second-head-label font-light">Strategic Output: {strategicOutputName}</h1>
			</div>
			...
			<div className="w-full flex justify-center py-7">
				<div className="w-5/7">
                    ...
                    <h3 className="mt-6">{`The visual representations below indicate the Forum Island Countries that have benefited from at least one project implementing Strategic Output: ${strategicOutputName}.`}</h3>
				</div>
			</div>
