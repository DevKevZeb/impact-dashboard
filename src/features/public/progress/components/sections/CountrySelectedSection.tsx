...
export default function CountrySelectedSection({ countryId, countryName }: Props) {
	const { data, isLoading, error } = useCountrySelected(countryId);

	return (
		<div className="w-full flex flex-col justify-center items-center">
			<div className="w-5/7 flex justify-center mb-20">
				<h1 className="mb-4 second-head-label font-light">Progress: {countryName}</h1>
			</div>

			<div className="w-full flex justify-center">
				<div className="w-5/7">
					<h1 className="third-head-label">Degree of Implementation</h1>
                    <h3 className="mt-6">{`The degree of implementation is represented as a percentage, indicating the extent of progress made in ${countryName} by averaging the progress across all Key Priority Areas (KPAs).`}</h3>
				</div>
			</div>
			...
			<div className="w-full flex justify-center py-7">
				<div className="w-5/7">
                    ...
                    <h3 className="mt-6">{`Resources allocated consolidates all the budgets designated for the projects implementing the Key Priority Areas in ${countryName}.`}</h3>
				</div>
			</div>
			<div className="w-full flex flex-col items-center py-7 justify-center">
				<div className="w-5/7 md:w-3/7 flex flex-col justify-center items-center gap-10">
			...
			<div className="w-full flex justify-center py-7">
				<div className="w-5/7">
					...
					<h3 className="mt-6">The visual representations below indicate which Key Priority Areas have benefitted from implementations in {countryName}.</h3>
				</div>
			</div>
			<div className="w-full flex flex-col items-center py-7 justify-center">
				<div className="w-5/7 md:w-3/7 flex flex-col justify-center items-center gap-10">
					{isLoading && <p>Loading...</p>}
					{error && <p>Error loading data</p>}
					{data?.beneficiaries && <StackBarChart data={data.beneficiaries}/>}
				</div>
			</div>
			...
			<div className="w-full flex justify-center py-7">
				<div className="w-5/7">
					...
					<h3 className="mt-6">This statistic quantifies, in percentage terms, the contribution made by each agency that implements at least one project in {countryName}.</h3>
				</div>
			</div>
			<div className="w-full flex flex-col items-center py-7 justify-center">
				<div className="w-5/7 md:w-3/7 flex flex-col justify-center items-center gap-10">
			...
			<div className="w-full flex justify-center py-7">
				<div className="w-5/7">
					...
					<h3 className="mt-6">This statistic quantifies, in percentage terms, the contribution made by each donor partner to the implementation of the Key Priority Areas in {countryName}.</h3>
				</div>
			</div>
			<div className="w-full flex flex-col items-center py-7 justify-center">
				<div className="w-5/7 md:w-3/7 flex flex-col justify-center items-center gap-10">
